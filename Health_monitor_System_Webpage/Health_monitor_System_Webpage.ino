...
float temperature, humidity, BPM, SpO2, bodytemperature,f;

/*Put your SSID & Password*/
char auth[] = "sfxCvt91ilIaZPSIA00S7vHwNyhqtKXa";
const char* ssid = "Hell yeah";  // Enter SSID here
const char* pass = "15369574";  //Enter Password here
...
void handle_OnConnect() {
  ...
  server.send(200, "text/html", SendHTML(temperature, humidity, BPM, SpO2, f));
}
...
String SendHTML(float temperature, float humidity, float BPM, float SpO2, float f) {
